...
function showConfirmationPopup({ title, message, confirmText, cancelText, onConfirm, onCancel }) { 
    ...
    popup.innerHTML = ` 
        ...
        <div class="button-group" style="display: flex; justify-content: center; gap: 15px; margin-top: 20px;"> 
            <button id="confirm-action-btn" class="reminder-close-button" style="margin: 0;">${escapeHTML(confirmText)}</button> 
            <button id="cancel-action-btn" class="reminder-close-button" style="margin: 0;">${escapeHTML(cancelText)}</button> 
        </div> 
    `; 
    document.body.appendChild(popup); 
