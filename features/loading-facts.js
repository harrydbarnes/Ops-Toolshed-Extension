(function() {
    ...
    const FACTS = window.LOADING_FACTS = Object.freeze([
        ...
        "This progress bar is not stuck, it is simply pacing itself",
        "Somewhere behind this screen, a server is doing its absolute best",
        "Your patience is being logged, though not yet actioned",
        "The page you requested is currently in a meeting with itself",
        "This spinner has seen things you would not believe, mostly other spinners",
        "Loading is a personal journey, and yours is nearly complete",
        "The bytes have been informed of the urgency and are unmoved",
        "Somewhere, a cursor is blinking in solidarity with you",
        "This delay has been carefully calibrated to build anticipation",
        "The server would like you to know it is trying its very best",
        "Your request is currently queueing behind several other requests, much like you are",
        "This is not buffering, this is dramatic pause",
        "The wheel spins not because it must, but because it can",
        "Somewhere in a data centre, a fan has just spun up in your honour",
        "This screen is technically working, in the loosest sense of the word",
        "Rome wasn't built in a day, and neither is this page, apparently",
        "The system appreciates your continued faith in it",
        "Your request has joined a small, exclusive queue of one",
        "A DSP, or demand-side platform, allows advertisers to buy impressions across multiple ad exchanges at once",
        "Frequency capping limits how many times the same person sees the same advert within a set period",
        "Viewability thresholds were standardised by the Media Rating Council to define what counts as 'seen'",
        "A tag manager allows marketers to deploy and update tracking pixels without touching a website's code",
        "Programmatic guaranteed deals fix both the price and the volume of impressions in advance",
        "An ad server's job is to decide which advert to serve, then to keep count of what happened next",
        "Post-view conversions count actions taken after someone saw an advert without clicking it at all",
        "A pixel firing 'server-side' happens on the backend rather than in the user's browser",
        "Attribution windows determine how long after a click or view a conversion is still credited to an advert",
        "A 'floor price' is the minimum amount a publisher will accept for an impression in an auction",
        "A calendar invite titled 'Quick catch up' has never once been quick",
        "The phrase 'circling back' has never once meant the conversation is finished",
        "'Bandwidth' originally referred to the range of frequencies a radio signal could occupy",
        "'Brief' comes from the Latin 'brevis', meaning short, a fact many campaign briefs seem to have forgotten",
        "The word 'budget' comes from the Old French 'bougette', meaning a small bag or purse",
        "'Deadline' and 'headline' both entered common use in the newspaper industry, for slightly different reasons",
        "A Wrike task with no assignee has a remarkably active social life of its own",
        "If Prisma could talk, it would probably just ask for the PO number again",
        "A reconciliation query resolved within 24 hours is considered a personal best",
        "The phrase 'should be a quick fix' has never once described what actually happened next",
        "WPP started out in 1971 as a company that made wire shopping baskets, called Wire and Plastic Products, long before it made a single media plan",
        "For a brief period in the 1980s, WPP was also the proud parent company of a teapot and jug manufacturer, becoming the parent company of Picquotware, a manufacturer of teapots and jugs, based in Northampton",
        "Before it became a WPP Media campus, One Southwark Bridge was the headquarters of the Financial Times, with WPP agreeing to lease the building in 2018 after the FT moved out.",
        "The Theobalds Road building, Mercury House, wasn't built for advertising at all, having opened in 1955 as the headquarters of Cable & Wireless and taken its name from the Roman god.",
        "Somewhere between Theobalds Road, Red Lion Square and One Southwark Bridge, an entire career's worth of meeting rooms have been booked, double booked, and quietly abandoned",
        "Every Teams meeting attended helps save a life",
        "Ensure any financial updates push through in Prisma as a success, so your day can be marked as a success",
        "Late booking billings mean loss of interest gained on the money sitting in WPP Media's accounts",
        "Derek at MediaOcean support is actually a real human. Despite this, no-one has ever met him.",
